...
namespace lubnamaster.Controllers
{
    public class ItemsController : Controller
    {
        ...
        {
            ViewBag.x = "item";
            var item = db.Items.Include(i => i.Categorei);
        ...
        public ActionResult Index(string search5)
        {
            if (search5 != null)
            {
                var abumahmood = db.Items.Where(x => x.Item_Name.Contains(search5) || x.Gender.Contains(search5)).ToList();
                return View(abumahmood);
            }
            else
            {
                var abumahmood = db.Items.ToList();
                return View(abumahmood);
            }
        }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.CategoryId = new SelectList(db.Categoreis, "CategoryId", "CategoryName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Item_Id,Item_Name,Item_Description,ItemPrice,Gender,CategoryId,Image1,Image2,Image3,Image4,Image5")] Item item  , HttpPostedFileBase Image1, HttpPostedFileBase Image2, HttpPostedFileBase Image3, HttpPostedFileBase Image4, HttpPostedFileBase Image5)
        {
            ...
            {
                ViewBag.CategoryId = new SelectList(db.Categoreis, "CategoryId", "CategoryName", item.CategoryId);
